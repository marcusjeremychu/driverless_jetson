...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/uwfsae/driverless_ws/src/perception)
  set(perception_DEVEL_PREFIX /home/uwfsae/driverless_ws/devel)
  ...
  set(perception_INSTALL_PREFIX /home/uwfsae/driverless_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uwfsae/driverless_ws/src/perception/${idir}'.  ${_report}")
    endif()
